...
import sys
import os
sys.path.append(os.path.realpath(os.path.join(os.path.dirname(__file__), os.pardir, os.pardir, 'slim')))

from lib.models.backbone import resnet_v1_beta
from lib.models.backbone import xception
